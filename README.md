...
- Internes, rollenbasiertes Hausverbot-/Casinosperren-System mit unveraenderlicher Historie; Details unter [docs/GUEST_RESTRICTIONS.md](docs/GUEST_RESTRICTIONS.md)
